...
var cricketwidget = (function () {
    	...
    	try {
    		...
    		if (data === false || data.current === "Data Not Found") {
    			if (helloCricketClass != null) {
    				let score_msg = "<br><b><hr><p><code>🔴 Currently No Live Match 🔴</code></p><hr><b><br>";
    				score_text(helloCricketClass, score_msg);
    			}
    		} else if (helloCricketClass != null) {
    			document.getElementsByTagName("meta").namedItem("description").setAttribute("content", `Live - ${data.title} - Get Real-time Live Cricket Score Update without refreshing the page.`);
    ...
    function score_text(helloCricketClass, text) {
    	for (let i = 0; i < helloCricketClass.length; i++) {
    		helloCricketClass[i].innerHTML = "<br><b><hr><p><code>🔵 Fetching the Live Score 🔵</code></p><hr><br><br>";
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ fetchscore, score_text });
    	return [];
    }
